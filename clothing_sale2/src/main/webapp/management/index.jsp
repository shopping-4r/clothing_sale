...
function link_operating(name,title){
	...
	<c:if test="${empty  orderData}">
		<jsp:forward page="../admin_findOrders.do" >
			...
			<div class="navbar-container" id="navbar-container">
               ...
               <ul class="nav ace-nav">	
				...
				<a data-toggle="dropdown" href="#" class="dropdown-toggle">
				 <span  class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small>${user2.nickname }</span>
				...
				<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
				 ...
				 <li class="divider"></li>
				 <li><a href="../login.jsp" id="Exit_system"><i class="icon-off"></i>退出</a></li>
				</ul>
			   </li>
	           <li class="purple">
